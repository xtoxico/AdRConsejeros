...
<html lang="en">
  ...
  ?>
    <div class="container">
      <div class="row-fluid">
        <div class="col-md-12">
          <h3>Añadir Carpetas / Restricciones de Tráfico</h3>

            <div class="row-fluid">
              <div class="col-md-12">
                <a class="btn btn-primary" href="addfolder.php?id=<?php echo $_GET['id'];?>">+ Añadir carpeta</a>
                <a class="btn btn-primary" href="addrtraf.php?id=<?php echo $_GET['id'];?>">+ Añadir Restricciones de Tráfico</a>
              </div>
            </div>
            <br>
            <br>
          <h3>Eliminar Carpetas / Restricciones de Tráfico </h3>
            ...
            <?php
              ...
              while ($row=mysqli_fetch_array($res)){
                ...
                $sql2 = 'select * from rtraf where id_carpeta="'.$row['id_carpeta'].'"';
                $res2 = mysqli_query($con,$sql2);
                while ($row2=mysqli_fetch_array($res2)){                  
                  echo '<tr><td></td><td>'.$row2['descripcion'].'</td><td><a class="delrtraf" data="'.$row2['id_rtraf'].'" title="Eliminar Restriccio"><i class="glyphicon glyphicon-remove"> </i></a></td></tr>';
                }
                $i++;
              }
