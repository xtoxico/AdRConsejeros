...
<html lang="en">
  ...
  ?>
    <div class="container">
      <div class="row-fluid">
        <div class="col-md-12">
          <h3>Actualizar carpeta</h3>
          <form action="action.php" method="GET">           
            <input name="id" id="id" type="hidden" value="<?php echo $_GET['id'];?>">
            <input name="action" id="action" type="hidden" value="upfolder">
            <input name="idfolder" id="idfolder" type="hidden" value="<?php echo $_GET['idfolder'];?>">
             <div class="form-group">
              <label for="data">Descrición de la carpeta</label>
              <input type="text" class="form-control" id="data" name="data" placeholder="Descripcion de la carpeta" value="<?php echo $_GET['foldername'];?>">
            </div>
