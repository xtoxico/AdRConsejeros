          ...
          <h3>Protocolos</h3>
            ...
            <?php
              ...
              while ($row=mysqli_fetch_array($res)){
                echo '<tr style="font-weight: bold"><td><img src="carpeta.jpg" style="width: 30px"></td><td><a href="protocolos.php?id='.$_GET['id'].'&id_carpeta='.$row['id_carpeta'].'">'.$row['descripcion'].'</a></td></tr>';                
