...
<nav class="navbar navbar-default navbar-fixed-top">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="http://adrconsejeros.es"><img src="http://adrconsejeros.es/img/logo-adr-color.png" style="width: 100px; margin-top: -5px;"></a>
        </div>
          ...
          ?>
            <li class="dropdown">
              ...
              <?php
                if ($userlog){
                  echo '
                      <li><a href="http://adrconsejeros.es/portal/circulares/carpetas.php?id='.$_GET['id'].'">Circulares</a></li>
                      <li><a href="http://adrconsejeros.es/portal/rtraf/carpetas.php?id='.$_GET['id'].'">Restricciones de Tráfico</a></li>
                      <li><a href="http://adrconsejeros.es/portal/formacion.php?id='.$_GET['id'].'">Formación Especifica</a></li>
                      <li><a href="http://adrconsejeros.es/portal/legislacion/carpetas.php?id='.$_GET['id'].'">Legislación</a></li>
                      <li><a href="http://adrconsejeros.es/portal/protocolos/carpetas.php?id='.$_GET['id'].'">Protocolos</a></li>
                      <li><a href="http://adrconsejeros.es/portal/seguridad.php?id='.$_GET['id'].'">Kits ADR y señalización</a></li>
                      <li><a href="http://adrconsejeros.es/portal/documentos.php?id='.$_GET['id'].'">Documentos de interes</a></li>
                      <li><a href="http://adrconsejeros.es/portal/enlaces.php?id='.$_GET['id'].'">Enlaces de interés</a></li>';
                }else{
                  echo '
