...
<html lang="en">
  ...
  ?>
    <div class="container">
      <div class="row-fluid">
        <div class="col-md-12">
          <h3>Añadir Circular</h3>
          <form action="action.php?id=<?php echo $_GET['id'];?>&action=addcircular" method="POST" enctype="multipart/form-data">                       
            ...
            <div class="form-group">
              <label for="data">Descrición de la Circular</label>
              <input type="text" class="form-control" id="data" name="data" placeholder="Descripcion de la circular">
            </div>
            <div class="form-group">
              <label for="data">Seleccionar ficheros <small>(debes seleccionar todos los ficheros a la vez)</small></label>
              <input type="file" name="cirfile[]" id="cirfile[]" multiple />
            </div>
