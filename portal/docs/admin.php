          ...
          <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
            ...
            <?php
              ...
              while ($row=mysqli_fetch_array($res)){
                ...
                echo '<table style="width: 100%">';
                $sql2 = 'select * from circulares where id_carpeta="'.$row['id_carpeta'].'" order by descripcion';
                $res2 = mysqli_query($con,$sql2);
                while ($row2=mysqli_fetch_array($res2)){                  
                  echo '<tr><td width="95%" style="padding-left: 20px">        '.$row2['descripcion'].'</td><td><a class="delcircular" data="'.$row2['id_circular'].'" title="Eliminar Circular"><i class="glyphicon glyphicon-remove"> </i></a></td></tr>';
                }
                echo '</table>';
                $i++;
                echo '</div>
